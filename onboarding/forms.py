...
class Onboarding_Form(ModelForm):
    class Meta:
        ...
        fields = ['add_attorney_more', 'pause_job', 'send_onboarding_email', 'add_to_spreadsheet',
                  'send_spreadsheet', 'save_license', 'onboarding_completed', 'save_offer_letter',
                  'puzzle_form', 'include_note', 'attach_copy_letter', 'employee_referral_form',
                  'return_ICA', 'notify_Huron',]
